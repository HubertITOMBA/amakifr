...
export const SERVER_ACTIONS_CONFIG: ServerActionConfig[] = [
  ...
  {
    action: "createCotisationsMensuelles",
    label: "Générer les cotisations mensuelles",
    description: "Créer les cotisations mensuelles pour tous les adhérents à partir des cotisations du mois",
    resource: "cotisations",
    defaultType: "WRITE",
    route: "/admin/cotisations-du-mois",
    category: "Cotisations",
  ...
  {
    action: "getAllTypesCotisationMensuelle",
    label: "Lister les types de cotisation",
    description: "Afficher la liste des types de cotisation mensuelle",
    resource: "cotisations",
    defaultType: "READ",
    route: "/admin/cotisations-du-mois",
    category: "Cotisations",
  ...
  {
    action: "createTypeCotisationMensuelle",
    label: "Créer un type de cotisation",
    description: "Créer un nouveau type de cotisation mensuelle",
    resource: "cotisations",
    defaultType: "WRITE",
    route: "/admin/cotisations-du-mois",
    category: "Cotisations",
  ...
  {
    action: "updateTypeCotisationMensuelle",
    label: "Modifier un type de cotisation",
    description: "Modifier un type de cotisation mensuelle existant",
    resource: "cotisations",
    defaultType: "WRITE",
    route: "/admin/cotisations-du-mois",
    category: "Cotisations",
  ...
  {
    action: "deleteTypeCotisationMensuelle",
    label: "Supprimer un type de cotisation",
    description: "Supprimer un type de cotisation mensuelle (si non utilisé)",
    resource: "cotisations",
    defaultType: "DELETE",
    route: "/admin/cotisations-du-mois",
    category: "Cotisations",
  ...
  // ========== RÉUNIONS MENSUELLES ==========
  {
    action: "getAllReunionsMensuelles",
    label: "Lister les réunions mensuelles",
    description: "Afficher la liste de toutes les réunions mensuelles",
    resource: "reunions",
    defaultType: "READ",
    route: "/reunions-mensuelles",
    category: "Réunions mensuelles",
  },
  {
    action: "getReunionMensuelleById",
    label: "Consulter une réunion mensuelle",
    description: "Voir les détails d'une réunion mensuelle spécifique",
    resource: "reunions",
    defaultType: "READ",
    route: "/reunions-mensuelles",
    category: "Réunions mensuelles",
  ...
  {
    action: "createReunionMensuelle",
    label: "Créer une réunion mensuelle",
    description: "Choisir un mois pour une réunion mensuelle (adhérent)",
    resource: "reunions",
    defaultType: "WRITE",
    route: "/reunions-mensuelles",
    category: "Réunions mensuelles",
  ...
  {
    action: "validerMoisReunion",
    label: "Valider le mois d'une réunion",
    description: "Valider le mois choisi par l'adhérent (admin)",
    resource: "reunions",
    defaultType: "WRITE",
    route: "/admin/reunions-mensuelles",
    category: "Réunions mensuelles",
  },
  {
    action: "updateReunionMensuelle",
    label: "Modifier une réunion mensuelle",
    description: "Modifier une réunion mensuelle (date, lieu, hôte, etc.)",
    resource: "reunions",
    defaultType: "WRITE",
    route: "/admin/reunions-mensuelles",
    category: "Réunions mensuelles",
  ...
  {
    action: "deleteReunionMensuelle",
    label: "Supprimer une réunion mensuelle",
    description: "Supprimer une réunion mensuelle",
    resource: "reunions",
    defaultType: "DELETE",
    route: "/admin/reunions-mensuelles",
    category: "Réunions mensuelles",
  ...
  {
    action: "confirmerParticipationReunion",
    label: "Confirmer sa participation à une réunion",
    description: "Indiquer si on sera présent, absent ou excusé",
    resource: "reunions",
    defaultType: "WRITE",
    route: "/reunions-mensuelles",
    category: "Réunions mensuelles",
