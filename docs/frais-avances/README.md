...
**Lot 4.5** : notif interne + outbox push règlement (compensation / remboursement / MIXTE parent) — flag off ; pas d’écritures financières nouvelles.
**Lots suivants** : correction, restitution, annulation, détachement RGPD.
